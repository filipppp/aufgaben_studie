...
def plot_files(stats, plt):
    ...
    titles = {"promptUser": "Submitted user prompt length", "responseGPT": "Response length by ChatGPT 4", "userCode": "Submitted code length", "gptCode": "Suggested code length from ChatGPT 4"}
    for key in files:
        boxplot(plt, [stats["distribution"]["lengths"][key]["simple"],
                ...
                ["Simple prompts", "Complex prompts", "Challenge 1", "Challenge 2"], titles[key], "Characters"
                )
